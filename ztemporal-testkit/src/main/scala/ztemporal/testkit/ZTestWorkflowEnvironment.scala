...
import ztemporal.worker.ZWorkerOptions
...
/**
  ...
  */
class ZTestWorkflowEnvironment private[ztemporal] (private val self: TestWorkflowEnvironment) extends AnyVal {
  ...
  /** Initiates an orderly shutdown in which polls are stopped and already received workflow and
    ...
    *
    * @see [[TestWorkflowEnvironment#shutdown]]
    */
  ...
  /** Initiates an orderly shutdown in which polls are stopped and already received workflow and
    ...
    *
    * @see [[TestWorkflowEnvironment#shutdownNow]]
    */
  ...
  /** Blocks until all tasks have completed execution after a shutdown request, or the timeout
    ...
    *
    * @param options await termination options
    */
...
object ZTestWorkflowEnvironment {
  ...
  /** Creates a new instance of [[ZTestWorkflowEnvironment]]
    *
    * @see [[TestWorkflowEnvironment.newInstance]]
    * @param options test environment options
    * @return managed instance of test environment
    */
