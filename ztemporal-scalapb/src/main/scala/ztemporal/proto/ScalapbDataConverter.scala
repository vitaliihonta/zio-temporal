...
object ScalapbDataConverter {
  ...
  /** Creates data converted supporting scalapb generated types.
    * Loads all available protobuf descriptors generated by scalapb.
    *
    * @param additionalFiles additional scalapb files to add
    * @return a [[DataConverter]] supporting given scalapb types
    */
  @experimentalApi
