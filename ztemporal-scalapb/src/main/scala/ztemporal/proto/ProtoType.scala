...
trait ProtoType[A] {
  ...
  /** Converts a value of this type to its protocol buffers representation
    ...
    * @return value protocol buffers representation
    */
  def repr(value: A): Repr

  /** Creates a value of this type from its protocol buffers representation
    * @param repr value protocol buffers representation
    * @return value of this type
    */
  def fromRepr(repr: Repr): A

  /** Creates a new protocol buffers type based on this representation.
    * via InvariantFunctor.imap
    *
    * @tparam B new value type
    * @param f function projecting this type into the given one
    * @param g reverse projection function
    * @return new protocol buffers type
    */
