package ztemporal.promise

import io.temporal.failure.CanceledFailure
import io.temporal.workflow.Async
import io.temporal.workflow.Promise
import zio.BuildFrom
import ztemporal.ZCanceledFailure
...
object ZPromise {
  ...
  private[ztemporal] final class Impl[E, A] private[ztemporal] (override val underlying: Promise[Either[E, A]])
