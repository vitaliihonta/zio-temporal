...
object ZSaga {
  ...
  final case class FromEither[E, A] private[ztemporal] (apply: () => Either[E, A]) extends ZSaga[Nothing, A]

  final case class Swap[E, A] private[ztemporal] (base: ZSaga[E, A]) extends ZSaga[A, E] {
    override def swap: ZSaga[E, A] = base
  }

  final case class Succeed[A] private[ztemporal] (value: A) extends ZSaga[Nothing, A] {
  ...
  final case class Failed[E] private[ztemporal] (error: E) extends ZSaga[E, Nothing] {
  ...
  final case class Compensation[E, A] private[ztemporal] (compensate: () => Unit, cont: ZSaga[E, A])
      extends ZSaga[E, A] {
  ...
  final case class Bind[E, A, B] private[ztemporal] (base: ZSaga[E, A], cont: A => ZSaga[E, B]) extends ZSaga[E, B] {
  ...
  final case class BindError[E0, E, A] private[ztemporal] (base: ZSaga[E0, A], cont: E0 => ZSaga[Nothing, E])
      extends ZSaga[E, A] {
  ...
  final case class CatchAll[E0, E, A] private[ztemporal] (base: ZSaga[E0, A], handle: E0 => ZSaga[E, A])
      extends ZSaga[E, A] {
  ...
  private[ztemporal] def runImpl[E, A](self: ZSaga[E, A])(options: ZSaga.Options): Either[E, A] = {
