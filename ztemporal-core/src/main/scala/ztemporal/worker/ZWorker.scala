...
/** Hosts activity and workflow implementations. Uses long poll to receive activity and workflow
  ...
  */
class ZWorker private[ztemporal] (
  ...
  /** Registers activity implementation objects with a worker. An implementation object can implement
    * one or more activity types.
    *
    * @see [[Worker#registerActivitiesImplementations]]
    */
...
object ZWorker {
  ...
  final class AddWorkflowDsl[I] private[ztemporal] (private val worker: ZWorker) extends AnyVal {

    /**
      * Registers workflow implementation classes with a worker. Can be called multiple times to add
      * more types.
      *
      * @param ctg workflow interface class tag
    ...
    /**
      * Registers workflow implementation classes with a worker. Can be called multiple times to add
      * more types.
      * @param cls workflow interface class tag
      * @see [[Worker#registerWorkflowImplementationTypes]]
      */
    ...
    /**
      ...
      * @param factory should create a workflow implementation
      * @param ctg workflow interface class tag
    ...
    /**
      ...
      * child workflows. An example of mocking a child workflow:
      *
      * @param cls workflow interface class
      * @param factory should create a workflow implementation
      * @see [[Worker#addWorkflowImplementationFactory]]
      */
