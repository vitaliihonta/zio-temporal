...
final class ZWorkflowStubBuilderTaskQueueDsl[A] private[ztemporal] (client: WorkflowClient, ctg: ClassTag[A]) {
...
final class ZWorkflowStubBuilderWorkflowIdDsl[A] private[ztemporal] (
...
final class ZWorkflowStubBuilder[A] private[ztemporal] (
  client:           WorkflowClient,
  ctg:              ClassTag[A],
  taskQueue:        String,
  workflowId:       String,
